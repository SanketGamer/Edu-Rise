...
const Footer = () => {
  ...
  return (
     <motion.div 
       className='bg-blue-100 rounded-t-3xl w-screen'
       initial="hidden"
       whileInView="visible"
       viewport={{ once: true, margin: "-100px" }}
     >
    <motion.div 
      className='max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-center justify-between py-10 px-4 gap-10'
    ...
    />
      ...
      <motion.div variants={itemVariants}>
        ...
        <motion.div 
          className='flex items-center px-4 -py-1 rounded-xl w-fit bg-black mt-1'
